...
library(sf)#Spatial data reading and manipulation
    ...
    tabsetPanel(id = "mainTabset",
      ...
      tabPanel(icon=icon("info"),"Developer",
        fluidRow(column(12,
                        ...
                        data collection for urban resilience. He was selected by the Permanent Secretary of PORALG to join the national technical on-field
                        committee for the establishment and development of Kwala Commercial and Investment City due to his expertise."),
                        br( "Johanes
                        holds a Bachelor of Science degree in Urban and Regional Planning and has extensive experience managing various projects within
